...
import { FaFacebook, FaYoutube, FaInstagram, FaCloudSun, FaNewspaper } from 'react-icons/fa';
    ...
    return (
        <div>
            ...
            <InfoSection
                ...
                content={
                    <>
                        <p>Vidreres is a charming municipality located in the region of La Selva. With a rich history and a vibrant culture, it serves as a gateway to the Costa Brava while maintaining its traditional essence.</p>
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2rem', marginTop: '2rem' }}>
                            <div style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
                                <h4 style={{ margin: '0 0 0.5rem', color: 'var(--color-primary)' }}>Population</h4>
                                <p style={{ margin: 0, fontWeight: 'bold', fontSize: '1.5rem' }}>8,000+</p>
                            </div>
                            <div style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
                                <h4 style={{ margin: '0 0 0.5rem', color: 'var(--color-primary)' }}>Area</h4>
                                <p style={{ margin: 0, fontWeight: 'bold', fontSize: '1.5rem' }}>48 km²</p>
                            </div>
                            <div style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#f9f9f9', borderRadius: '8px' }}>
                                <h4 style={{ margin: '0 0 0.5rem', color: 'var(--color-primary)' }}>Elevation</h4>
                                <p style={{ margin: 0, fontWeight: 'bold', fontSize: '1.5rem' }}>93 m</p>
                            </div>
                        </div>
                    </>
                }
            ...
            <section style={{ padding: '1rem 0', backgroundColor: 'white' }}>
                <div className="container" style={{ textAlign: 'center' }}>
                    <h3 style={{ fontSize: '2rem', marginBottom: '1.5rem', color: 'var(--color-secondary)' }}>Experience the Essence</h3>
                    <div style={{
                        maxWidth: '800px',
                        margin: '0 auto',
                        aspectRatio: '16/9',
                        ...
                        <video controls width="100%" height="100%" poster="/media/img/layout/vidreres-2.png">
                            <source src="/media/VIDRERES_VIDEO.mp4" type="video/mp4" />
            ...
            <section style={{ padding: '1rem 0', backgroundColor: '#f0f0f0' }}>
                <div className="container">
                    <h2 style={{ fontSize: '2rem', marginBottom: '2rem', textAlign: 'center' }}>Fairs, Festivals & Traditions</h2>
            ...
            <section style={{ padding: '1rem 0' }}>
                <div className="container">
                    <h2 style={{ fontSize: '2rem', marginBottom: '2rem', textAlign: 'center' }}>Historic Buildings</h2>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                        <HoverCard
            ...
            <section style={{ padding: '1rem 0', backgroundColor: '#f0f0f0' }}>
                <div className="container">
                    <h2 style={{ fontSize: '2rem', marginBottom: '2rem', textAlign: 'center' }}>Natural Areas</h2>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
                        <HoverCard
            ...
            <section style={{
                ...
                <div className="container" style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flex: '1 1 250px' }}>
                        ...
                        <div>
                            <h4 style={{ margin: 0, color: 'var(--color-primary)' }}>Temp: 18°C</h4>
                            <small>Sunny | Wind: 12km/h</small>
                        </div>
                    </div>

                    {/* News Tickler */}
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', flex: '1 1 250px', borderLeft: '1px solid #333', paddingLeft: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '1.5rem', flex: '0 0 auto' }}>
                        <a href="#facebook" style={{ color: 'white', transition: 'color 0.3s' }}><FaFacebook size={30} /></a>
                        <a href="#youtube" style={{ color: 'white', transition: 'color 0.3s' }}><FaYoutube size={30} /></a>
                        <a href="#instagram" style={{ color: 'white', transition: 'color 0.3s' }}><FaInstagram size={30} /></a>
                    </div>

                    {/* Navigation Menu */}
                    <nav style={{ flex: '0 0 auto' }}>
                        <ul style={{ display: 'flex', gap: '1.5rem', listStyle: 'none', margin: 0, padding: 0 }}>
                            <li><Link to="/" style={{ color: 'var(--color-primary)', textDecoration: 'none' }}>Home</Link></li>
                            <li><Link to="/calendar" style={{ color: 'white', textDecoration: 'none' }}>Calendar</Link></li>
