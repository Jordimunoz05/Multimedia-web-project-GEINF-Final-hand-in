                ...
                {events.map(event => (
                    <div key={event.id} style={{
                        ...
                        <div style={{
                            ...
                            <span style={{ fontSize: '1.5rem', fontWeight: 'bold', textAlign: 'center' }}>{event.date}</span>
                        </div>
                        ...
                        <div style={{ padding: '1.5rem', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            <h3 style={{ margin: '0 0 0.5rem', fontSize: '1.3rem' }}>{event.title}</h3>
                            <p style={{ margin: 0, color: '#666' }}>📍 {event.location} &nbsp;|&nbsp; 🕒 {event.time}</p>
                        </div>
                    </div>
                ))}
            </div>
